...
public class CommunityService {
    ...
    //리뷰 작성
    /*
    public CommunitySaveResponseDto postCommunity(String type, Long userId, String title, String content, String image) {
        try{
            User user = entityManager.find(User.class, userId);
            Community community = new Community(user, type, title, content, writer, false, 0, image);
